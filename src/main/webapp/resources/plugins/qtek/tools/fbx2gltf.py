...
if __name__ == "__main__":
    try:
        ...
        import platform
        errmsg = 'You need to copy the content in compatible subfolder under /lib/python<version> into your python install folder such as '
        if platform.system() == 'Windows' or platform.system() == 'Microsoft':
            errmsg += '"Python26/Lib/site-packages"'
        elif platform.system() == 'Linux':
            errmsg += '"/usr/local/lib/python2.6/site-packages"'
        elif platform.system() == 'Darwin':
            errmsg += '"/Library/Frameworks/Python.framework/Versions/2.6/lib/python2.6/site-packages"'
        errmsg += ' folder.'
        print(errmsg)
        sys.exit(1)
