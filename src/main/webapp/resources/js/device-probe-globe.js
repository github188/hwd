 ...
 * chart.addData()
 ...
 e.preventDefault();
 //http://www.oschina.net/question/1263361_161662
 chart.getOption().legend.data.forEach(function (name) {
 chart.component.legend.setSelected(name, false);
 });
 chart.component.legend.setSelected($(this).text(), true);
 $(this).addClass("selected");
 });

 $('.item').on('click', function () {
 console.log($(this).siblings("div:first"));
 });
 */
