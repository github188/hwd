...
<div id="main">
    <%--    <div class="panel-group" id="legend" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default item">
                <div class="panel-heading" role="tab" id="headingOne">
                    <h4 class="panel-title">
                        <a role="button" data-toggle="collapse" data-parent="#legend" href="#monitor" aria-expanded="true"
                           aria-controls="monitor">
                            监控设备 <i class="glyphicon glyphicon-menu-down monitor"></i>
                        </a>
                    </h4>
                </div>
                <div id="monitor" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        <ul>
                            <li>
                                <span class=" monitor-no-control"></span>
                                <a href="#" class="subItem">无控制权限</a>
                            </li>
                            <li>
                                <span class="monitor-with-picture"></span>
                                <a href="#" class="subItem">可查看监控画面</a></li>
                            <li>
                                <span class="monitor-control"></span>
                                <a href="#" class="subItem">可获取控制权限</a>
                            </li>
                            <li>
                                <span class="monitor-backdoor"></span>
                                <a href="#" class="subItem">可植入后门</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#legend" href="#collapseTwo"
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingThree">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#legend"
    ...
    <div id="legend">
        ...
        <div class=" item">
            <a href="<%=basePath%>api/getDevices4Globe/security_matter/all/1" data-toggle="collapse" data-target="#secret"
               id="secretTitle">涉密设备
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        <a class="subItem" href="<%=basePath%>api/getDevices4Globe/security_matter/implantable/2">可植入后门</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="item">
            <a href="<%=basePath%>api/getDevices4Globe/network_device/all/2" data-toggle="collapse" data-target="#netDevice"
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        <a href="<%=basePath%>api/getDevices4Globe/network_device/implantable/2" class="subItem">可植入后门</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <%--<div id="brand">
        ...
        <%--  style="height: 600px;width: 800px;margin-left: 25rem" --%>
